    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            player = new Player(this, Content.Load<Texture2D>(@"Images/AnimatedSprites/vanligTexture"), Content.Load<Texture2D>(@"Images/AnimatedSprites/militarTexture"),
                ...
                Content.Load<Texture2D>(@"Images/AnimatedSprites/militarTexture"), Content.Load<Texture2D>(@"Images/AnimatedSprites/skalligTexture"),
            ...
            Registry.currentRoom = Registry.rooms[89];                               // Startrummet
